...
/**
 * Tests for OAuth2FacebookGenerateAuthorizeEndpointFunction
 */
class OAuth2FacebookGenerateAuthorizeEndpointFunctionTest {

	private static final String CLIENT_ID = "test-client-id";
	private static final String CLIENT_SECRET = "test-client-secret";
	private static final String REDIRECT_URI = "https://example.com/callback";
	private static final String AUTHORIZE_ENDPOINT = "https://www.facebook.com/v12.0/dialog/oauth";
	private static final String SCOPE = "public_profile,email";
	private static final String TOKEN_ENDPOINT = "https://graph.facebook.com/v12.0/oauth/access_token";

	private OAuth2FacebookConfig config;
	private OAuth2FacebookGenerateAuthorizeEndpointFunction function;

	@BeforeEach
	void setUp() {
		config = new OAuth2FacebookConfig(
				CLIENT_ID,
				CLIENT_SECRET,
				REDIRECT_URI,
				AUTHORIZE_ENDPOINT,
		...
		function = new OAuth2FacebookGenerateAuthorizeEndpointFunction(config);
	}
	...
	void shouldIncludeScope() throws UnsupportedEncodingException {
		...
		assertThat(decoded).contains("public_profile");
	...
	@Test
	void shouldHandleMultipleScopes() throws UnsupportedEncodingException {
		State state = new State("test-state");
	...
	@Test
	void shouldHandleGraphAPIVersion() {
		State state = new State("test-state");

		String url = function.generate(state);

		// Should use the configured Graph API version endpoint
		assertThat(url).startsWith("https://www.facebook.com/v12.0/dialog/oauth");
	}
}
